...
> **Status**: draft, test 001 PENDING (2026-06-29). The **sixth `hazard`-domain resource** — covering the tornado family alongside the five sibling hazard resources. Authored to match the live InfraSure MCP data structure; test 001 targets the Southern Plains / Oklahoma–Texas tornado corridor.
...
examples/applied_insight_001.md   the target output — OK/TX wind tornado corridor (PENDING)
