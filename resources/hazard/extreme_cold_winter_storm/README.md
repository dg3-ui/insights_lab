...
GROUNDS    get_plant (geometry/fuel/owner) · search_plants/aggregate (TX gas/wind/solar fleet) ·
           NOAA NWS (freeze geography + event window) · FERC/NERC Uri report (regional event + outage scale) ·
...
**See also**: `../README.md` (the registry) · `../../docs/method/resource_standard.md` (the contract + peril-field/non-stationarity standard) · `../hail_solar/` · `../hurricane_high_wind_wind/` (sibling hazard resources) · `../../docs/status/mcp_gaps.md`.
