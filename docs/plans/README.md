...
| [2026-06-25_client_delivery_drive_layer.md](2026-06-25_client_delivery_drive_layer.md) — the business-development Drive handoff: client-centric / climate-centric folders, deep client profiles, agent-curated profiles, and Drive-promotion QA | 2026-06-25 | **IN PROGRESS** — tracker staged locally; `.research_lab` linked; AIG Project Finance Group pilot prompt drafted; final Drive naming still needed |
