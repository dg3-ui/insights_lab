# Output Contract Cell — <direction> × <audience> × <format>
...
| Envelope | Value |
|---|---|
| Status | filled / stub (which plan phase fills it) |
| Rendering | HTML artifact (`brand_assets/artifact_skeleton.html`) / markdown / DOCX export |
| Length | <band — words · charts> |
| Tone | `voice.md` §1–§2 + <register note> |
| Gate guard | validated insight only + <any cell-specific guard, e.g. named-account review for client cells> |

Structure (the moves, in order — keep to 5–9):
